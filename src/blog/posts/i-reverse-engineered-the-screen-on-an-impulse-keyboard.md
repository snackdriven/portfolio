...
I had Claude reading captures with me, and it was confident and wrong in exactly the way I keep writing about here. It labeled things backwards. It invented a tidy little formula that fell apart the second real pixels went through it. Every time, the fix was the same boring thing: stop trusting the summary, run the actual numbers. Four thousand-odd packets either match your formula or they don&rsquo;t. Mine didn&rsquo;t, until it did.

So there&rsquo;s a programmable tiny TV on my keyboard now, which, if you&rsquo;ve read anything else here, is my whole personality showing up in hardware. And the impulse buy has been retroactively reclassified as research. That&rsquo;s allowed. I checked.
