...
If there&rsquo;s a lesson in the last few days, it&rsquo;s that I was wrong about this keyboard over and over, sure of myself every time. Column-first pixels, the phantom light strip, the secret radio channel, the safety delays. They all felt right, and they were all detours, and the detours are the only reason I know how the thing actually works now. The last thing I gave up was the idea that my own fix was helping. Every version that made it worse was pointing right at the part I wasn&rsquo;t looking at.
